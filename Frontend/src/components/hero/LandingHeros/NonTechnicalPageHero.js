...
export default ({
	heading = "Welcome " + <Heading>userName</Heading>,
	...
	primaryButtonText = "Let's begin our learning journey",
	primaryButtonUrl = "/components/innerPages/NonTechnicalTopics",
	...
	const navLinks = [
		<NavLinks key={1}>
			...
			<NavLink href="/components/innerPages/NonTechnicalTopics">
					...
					<ContentWithVerticalPadding>
						<Row>
							<TextColumn>
								...
								<PrimaryButton
									as="a"
									href={`/components/innerPages/NonTechnicalTopics`}
								>
									{primaryButtonText}
								</PrimaryButton>
							</TextColumn>
